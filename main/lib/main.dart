...
class _FirstPageState extends State<FirstPage> with TickerProviderStateMixin {
  ...
  Icon _notifyIcon = new Icon(IconData(0xe7f7, fontFamily: 'MaterialIcons'), color: Colors.yellowAccent);
        ...
        child:Scaffold(
          ...
          body: TabBarView(
            children:[
              ...
              new Container(
                margin: new EdgeInsets.symmetric(horizontal: 2.0, vertical: 8.0),
...
ListTile makeListTile(index) {
        ...
        title: 
          Row(
            ...
            // Align(
                    ...
                    child: Text('${palette[index].keys.first}',
        ...
        subtitle: Column(
          ...
          children: <Widget>[
            ...
            Align(
                ...
                children: <Widget>[
                             Icon(IconData(0xe916, fontFamily: 'MaterialIcons'), color: Colors.yellowAccent),
            Text(' ${dates[index].keys.first}, ',style: TextStyle(color: Colors.white)),
            Text('${dates[index].values.first}', style: TextStyle(color: Colors.white)),
                ])
            ),
            ]),
            ...
            children: <Widget>[
                ...
                child: FlatButton.icon(onPressed:() => _contactPressed("tel:7358527747") , icon: new Icon(IconData(0xe0b0, fontFamily: 'MaterialIcons'), color: Colors.yellowAccent),label:Text("")),
              
            ),
             Align(
                alignment: Alignment.bottomRight,
                child: FlatButton.icon(onPressed: _notifyPressed, icon: _notifyIcon,label:Text("")),
  ...
  void _notifyPressed ()
  {
    Icon _notifytemp = new Icon(IconData(0xe7f7, fontFamily: 'MaterialIcons'), color: Colors.yellowAccent);
    Icon _notifyOff = new Icon(IconData(0xe7f6, fontFamily: 'MaterialIcons'), color: Colors.yellowAccent);
    setState(() {
    ...
    if (!(_searchText.isEmpty)) {
      ...
      for (int i = 0; i < filteredNames.length; i++) {
        for(int j=0;j<filteredNames[i].length;j++)  {
          if(filteredNames[i][j].toLowerCase().contains(_searchText.toLowerCase()))  {
